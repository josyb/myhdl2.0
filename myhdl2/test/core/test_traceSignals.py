...
from myhdl2 import block, Signal, Simulation, _simulator, delay, instance, intbv
from myhdl2._traceSignals import TraceSignalsError, _error, traceSignals
...
@block
def tristate():
    from myhdl2 import TristateSignal
    clk = Signal(bool(0))
