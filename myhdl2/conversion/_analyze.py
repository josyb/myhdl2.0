...
import myhdl2
from myhdl2 import *
from myhdl2 import ConversionError
from myhdl2._always_comb import _AlwaysComb
from myhdl2._always_seq import _AlwaysSeq
from myhdl2._always import _Always
from myhdl2.conversion._misc import (_error, _access, _kind,
                                    _ConversionMixin, _Label, _genUniqueSuffix,
                                    _get_argnames)
from myhdl2._extractHierarchy import _isMem, _getMemInfo, _UserCode
from myhdl2._Signal import _Signal, _WaiterList
from myhdl2._ShadowSignal import _ShadowSignal, _SliceSignal, _TristateDriver
from myhdl2._util import _isTupleOfInts
from myhdl2._util import _makeAST
# from myhdl2._resolverefs import _AttrRefTransformer

myhdlObjects = myhdl2.__dict__.values()
...
#             if not signame:
        ...
        elif isinstance(attrobj, myhdl2.EnumType):
            pass
