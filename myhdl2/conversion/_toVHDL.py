...
import myhdl2
# from myhdl2 import *
from myhdl2 import ToVHDLError, ToVHDLWarning
from myhdl2._extractHierarchy import (_HierExtr, _isMem, _getMemInfo,
                                     _UserVhdlCode, _userCodeMap)

from myhdl2._instance import _Instantiator
from myhdl2._Signal import _Signal, _WaiterList, posedge, negedge
from myhdl2._enum import EnumType, EnumItemType
from myhdl2._intbv import intbv
from myhdl2._modbv import modbv
from myhdl2._simulator import now
from myhdl2._concat import concat
from myhdl2._delay import delay
from myhdl2._misc import downrange
from myhdl2._util import _flatten
from myhdl2._ShadowSignal import _TristateSignal, _TristateDriver
from myhdl2._block import _Block
from myhdl2._getHierarchy import _getHierarchy
from myhdl2.conversion._misc import (_error, _kind, _context,
                                    _ConversionMixin, _Label, _genUniqueSuffix, _isConstant)
from myhdl2.conversion._analyze import (_analyzeSigs, _analyzeGens, _analyzeTopFunc,
                                       _Ram, _Rom, _enumTypeSet)
from myhdl2.conversion._toVHDLPackage import _package
from myhdl2.conversion._VHDLNameValidation import _nameValid, _usedNames

from myhdl2 import bin as tobin

_version = myhdl2.__version__.replace('.', '')
...
class _ToVHDLConvertor(object):
    ...
    def __call__(self, func, *args, **kwargs):
        ...
        if _converting:
            ...
            # clean start
            sys.setprofile(None)
        from myhdl2 import _traceSignals
